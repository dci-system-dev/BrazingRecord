...
namespace Brazing_Serial
{
    class ConnectDBIoT
    {
        ...
        private string connStr = "Data Source=" + Properties.Settings.Default.Server + ";Initial Catalog=" + Properties.Settings.Default.DB + "; Persist Security Info=True; User ID=sa;Password=decjapan;";
